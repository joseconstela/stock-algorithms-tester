...
>
> Given a ticker, runs (python) trading algorithms to detect buy/sell signals.
>
...
This software is provided "as is", without warranty of any kind, express or implied. The author nor its contributors take no responsibility for any outcomes, losses, or damages resulting from the use of this software or any decisions made based on its output.

The accuracy of the signals, indicators, and analysis generated by this software is not guaranteed. This tool is for educational and experimental purposes only and should not be relied upon for actual trading or financial decisions. Use it at your own risk.
